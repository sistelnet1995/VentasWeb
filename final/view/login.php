...
<head>
    ...
    <title><?php echo $_SESSION['Sistema'] . 'Inicio de Sesión'; ?></title>
</head>
    ...
    <section>
        <div class="container col-md-5 mt-5">
            <div class="form-group">
                ...
                <input type="text" name="UserName" id="UserName" class="form-control text-lowercase" placeholder="Usuario o Email">
            </div>
            <div class="form-group">
